...
export default function Modal() {
  ...
  return (
    <>
      <div>
        <ModalBtn className="ModalBtn" onClick={handleAttend}>
          <svg
            width="33"
            height="33"
            viewBox="0 0 33 33"
      ...
      {attend && (
        <ModalContainer className="ModalContainer" onClick={closeAttendF}>
          <ModalView className="ModalView" onClick={e => e.stopPropagation()}>
            <div onClick={closeAttendF} className="close-btn" role="none">
              &times;
            </div>
            <div className="desc">
